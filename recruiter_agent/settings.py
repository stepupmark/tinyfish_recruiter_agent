"""
Django settings for recruiter_agent project.
...
ROOT_URLCONF = 'recruiter_agent.urls'
...
WSGI_APPLICATION = 'recruiter_agent.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='stepupmark.developers@gmail.com')
